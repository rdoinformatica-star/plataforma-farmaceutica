...
const NAV = [
  {
    ...
    itens: [
      ...
      { para: '/estoque', rotulo: 'Estoque', Icone: Warehouse },
      { para: '/compra', rotulo: 'Compra', Icone: ShoppingCart },
      { para: '/mercado', rotulo: 'Mercado', Icone: Globe },
      { para: '/preco', rotulo: 'Preço', Icone: Coins },
    ],
  },
  {
    grupo: 'Dados',
